            ...
            <div class="container-fluid">
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6 " style="text-align: right;">
                        <a href="{{url('admin/teacher/add')}}" class="btn btn-primary">Adauga profesori</a>
                    </div>
                ...
                <div class="col-md-12">
                    ...
                    <div class="card ">
                        <div class="card-header">
                            <h3 class="card-title">Cauta un profesor</h3>
                        </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-3">
                                        ...
                                        <a href="{{url('admin/teacher/list')}}" class="btn btn-primary" style="margin-top: 30px">Reseteaza</a>
                                    </div>
                                </div>
            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Lista Profesori</h3>
                            </div>
                            <!-- /.card-header -->
                                ...
                                <table class="table">
                                    ...
                                    @foreach($getRecord as $value)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{url('admin/teacher/edit' , $value->id)}}" class="btn btn-primary">Editeaza</a>
                                                <a href="{{url('admin/teacher/delete' , $value->id)}}" class="btn btn-danger">Sterge</a>
                                            </td>
                                        </tr>
                                    @endforeach
                                    </tbody>
