                            ...
                            <form method="post" action="">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group col-md-6">
                                        <label >Prenume </label>
                                        <input type="text" class="form-control" value="{{old('name', $getRecord->name)}}" name="name" required placeholder="Introduceti prenume">
                                    </div>

                                    <div class="form-group col-md-6">
                                        <label >Nume</label>
                                        <input type="text" class="form-control" value="{{old('last_name', $getRecord->last_name)}}" name="last_name" required placeholder="Introduceti nume">
                                    </div>
